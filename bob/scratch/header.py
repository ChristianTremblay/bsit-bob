...
"""
SAMPLE_HEADER_SUFFIX = """# baseURI: http://data.ashrae.org/standard223/1.0/sample/{sample_name}-{suffix}
# imports: http://data.ashrae.org/standard223/1.0/model/all
...
def sample_header(sample_name, suffix=None):
    ...
    _header = SAMPLE_HEADER_SUFFIX if suffix else SAMPLE_HEADER
    return _header.format(sample_name=sample_name, suffix=suffix)
