...
g36fig_a_2 = FunctionBlock(label="G36_FIG_A_1", comment=sequence)
# zoneSetpointAdj = AnalogIn(label='Zone Setpoint Adjust', function_block=g36fig_a_2)
# LocalOverride = BinaryIn(label='Local Override', function_block=g36fig_a_2)
# zoneTemp = AnalogIn(label='Zone Temp', function_block=g36fig_a_2)
# zoneCO2 = AnalogIn(label='Zone CO2', function_block=g36fig_a_2)
...
g36fig_a_2.uses(vav.airFlow, AnalogIn, "supplyAirFlow")
g36fig_a_2.uses(hvac_zone.temperature_setpoint, AnalogIn, "zoneTemperatureSetpoint")
g36fig_a_2.uses(hvac_zone.temperature, AnalogIn, "zoneTemperature")
g36fig_a_2.uses(vav["supplyAirTemperature"], AnalogIn, "supplyAirTemprature")
g36fig_a_2.uses(hvac_zone.co2, AnalogIn, "zoneCO2")
g36fig_a_2.uses(hvac_zone.windows_switch, BinaryIn, "window-switch")
g36fig_a_2.uses(occupancy.hasOccupancyStatus, BinaryIn, "occupancy-status")
g36fig_a_2.produces(vav["damperPosition"], AnalogOut, "damperPosition")
g36fig_a_2.produces(vav["valvePosition"], AnalogOut, "valvePosition")
