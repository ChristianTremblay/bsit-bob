...
class ParkingSlotCold(Garage):
    pass


class ParkingSlotWarm(Garage):
    pass
...
class Zone(Architecture):
    """
    A sub-zone within a building defined to support some technology and/or
    use, e.g., an HVAC zone, a security zone, etc.
    """
...
class EquipmentCollection(AssetCollection):
    pass


class FurnitureCollection(AssetCollection):
    pass
...
class SpaceCollection(Collection):
    pass


class Apartment(SpaceCollection):
    pass


class Campus(SpaceCollection):
    """
