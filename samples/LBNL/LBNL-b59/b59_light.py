...
for zn in lighting_sys_df['Location'].dropna().unique(): # creating the lighting zones I can't find rooms for too.
...
for i, sn in enumerate(lighting_sens_df['Sensor Name']):
    ...
    lsens[sn].hasMeasurementLocation = lighting_zones[lighting_sens_df.Location[i]] #making the zone the measurement location of the Sensor
...
p3=UFPlenum(label="Floor_3.UFPlenum") #A plenum for both floors??? Break it into segments? Multiple plenums on each floor? 
