...
class Chilled_Water_Circulator_Pump(Circulator_Pump, Chilled_Water_Pump):
    """
...
class Boiler(HVAC_Equipment, Water_Heater):
    """
...
class Exhaust_Fan_Enable_Command(Command):
    pass
...
class Occupied_Supply_Air_Temperature_Setpoint(
    Occupied_Air_Temperature_Setpoint, Supply_Air_Temperature_Setpoint
):
    pass
...
class Differential_Pressure_Load_Shed_Status(Load_Shed_Status, Pressure_Status):
    pass
...
class Speed_Mode_Status(Mode_Status, Speed_Status):
    """
...
class Cooling_Discharge_Air_Flow_Setpoint:
    """
...
class Heating_Discharge_Air_Flow_Setpoint:
    """
